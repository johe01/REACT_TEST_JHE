...
public class BoardController {
    ...
    public ResponseEntity<?> getAllBoard(
        ...
        try {
            ...
            // PageInfo<Boards> pageInfo = boardService.listWithThumbnail(page, size);
    ...
    public ResponseEntity<?> createBoardFormData(Boards board) {
        ...
        try {
            ...
            if( result ) {
                return new ResponseEntity<>("Form SUCCESS", HttpStatus.CREATED);
            } else {
    ...
    public ResponseEntity<?> createBoardJSON(@RequestBody Boards board) {
        try {
            boolean result = boardService.insert(board);
            if( result ) {
                return new ResponseEntity<>("JSON SUCCESS", HttpStatus.CREATED);
            } else {
                return new ResponseEntity<>("FAIL", HttpStatus.BAD_REQUEST);
            }
        } catch (Exception e) {
    ...
    public ResponseEntity<?> updateBoardForm(Boards board) {
        try {
            ...
            if( result ) {
                return new ResponseEntity<>("Form SUCCESS", HttpStatus.OK);
            } else {
                return new ResponseEntity<>("FAIL", HttpStatus.BAD_REQUEST);
            }
        } catch (Exception e) {
    ...
    public ResponseEntity<?> updateBoardJSON(@RequestBody Boards board) {
        try {
            boolean result = boardService.updateById(board);
            if( result ) {
                return new ResponseEntity<>("JSON SUCCESS", HttpStatus.OK);
            } else {
                return new ResponseEntity<>("FAIL", HttpStatus.BAD_REQUEST);
            }
        } catch (Exception e) {
